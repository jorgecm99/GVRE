        ...
        <footer>
            <div className='footer'>
                ...
                <div className='footer__right'>
                    ...
                    <a href='https://instagram.com/gv_real_estate_?utm_medium=copy_link'><img src={footer_instagram} alt='instagram'/></a>
                    <a href='https://www.linkedin.com/company/gv-real-estate/'><img src={footer_linkedin} alt='linkedin'/></a>
                </div>
            </div>
        </footer>
    )
