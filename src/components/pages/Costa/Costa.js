...
const Costa = () => {
    ...
    useEffect(() => {
        ...
        for(let i = 0; i<pageCount; i++){
            elements.push(
                <li className='campoRustico__pagination__list__item'><a href={`https://modest-darwin-2e96d1.netlify.app/costa/${i+1}`}>{i+1}</a></li>
            )
        }
            ...
            <div>
                ...
                <div className='costa__pagination'>
                    <ul className='costa__pagination__list'>
                        <li className='costa__pagination__list__item'><a className='campoRustico__pagination__list__item__back' href={`https://modest-darwin-2e96d1.netlify.app/singular/${pageNumber}`}> <img src={mayor} alt='simbolo mayor' /> </a></li>
                        {pagElements}
                        <li className='costa__pagination__list__item'><a className='campoRustico__pagination__list__item__next' href={`https://modest-darwin-2e96d1.netlify.app/singular/${pageNumber+2}`}> <img src={mayor} alt='simbolo menor' /> </a></li>
                    </ul>
                </div>
                <ContactIndex/>
            </div>
